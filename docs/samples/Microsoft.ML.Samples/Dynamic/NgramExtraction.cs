    ...
    public partial class NgramTransformSamples
    {
        public static void NgramTransform()
        {
            ...
            Action<string, IEnumerable<VBuffer<float>>, VBuffer<ReadOnlyMemory<char>>> printHelper = (columnName, column, names) =>
           {
            ...
            transformedData_onechars.Schema["CharsUnigrams"].Annotations.GetValue(MetadataUtils.Kinds.SlotNames, ref slotNames);
            ...
            transformedData_twochars.Schema["CharsTwograms"].Annotations.GetValue(MetadataUtils.Kinds.SlotNames, ref slotNames);
