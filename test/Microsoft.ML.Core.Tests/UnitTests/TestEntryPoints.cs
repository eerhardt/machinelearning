...
namespace Microsoft.ML.RunTests
{
    public partial class TestEntryPoints : CoreBaseTestClass
    {
        ...
        public void EntryPointPipelineEnsemble()
        {
            ...
            var type = binaryScored.Schema[scoreCol.Value.Index].Annotations.Schema.GetColumnOrNull(MetadataUtils.Kinds.ScoreColumnKind)?.Type;
            ...
            binaryScored.Schema[scoreCol.Value.Index].Annotations.GetValue(MetadataUtils.Kinds.ScoreColumnKind, ref kind);
            ...
            type = regressionScored.Schema[scoreCol.Value.Index].Annotations.Schema[MetadataUtils.Kinds.ScoreColumnKind].Type;
            Assert.True(type is TextDataViewType, "Regression ensemble scored data does not have correct type of metadata.");
            regressionScored.Schema[scoreCol.Value.Index].Annotations.GetValue(MetadataUtils.Kinds.ScoreColumnKind, ref kind);
            ...
            type = anomalyScored.Schema[scoreCol.Value.Index].Annotations.Schema[MetadataUtils.Kinds.ScoreColumnKind].Type;
            Assert.True(type is TextDataViewType, "Anomaly detection ensemble scored data does not have correct type of metadata.");
            anomalyScored.Schema[scoreCol.Value.Index].Annotations.GetValue(MetadataUtils.Kinds.ScoreColumnKind, ref kind);
...
#pragma warning restore 0618
        ...
        public void TestCrossValidationMacroWithMultiClass()
        {
            ...
            Assert.True(foldCol.HasValue);
            var type = schema["Count"].Annotations.Schema[MetadataUtils.Kinds.SlotNames].Type;
