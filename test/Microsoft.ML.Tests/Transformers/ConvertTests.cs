...
namespace Microsoft.ML.Tests.Transformers
{
    public class ConvertTests : TestDataPipeBase
    {
        ...
        public void ValueToKeyFromSideData()
        {
            ...
            output.Schema["CatA"].Annotations.GetValue(MetadataUtils.Kinds.KeyValues, ref slotNames);
        ...
        {
            Assert.Equal(result.Schema["ConvA"].Annotations.Schema.Select(x => x.Name), new string[2] { MetadataUtils.Kinds.SlotNames, MetadataUtils.Kinds.IsNormalized });
            ...
            Assert.Equal(result.Schema["ConvB"].Annotations.Schema.Select(x => x.Name), new string[1] { MetadataUtils.Kinds.KeyValues });
