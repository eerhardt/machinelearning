    ...
    public partial class TrainerEstimators
    {
        ...
        public void TreeEnsembleFeaturizerOutputSchemaTest()
        {
...

            {
                ...
                treeValuesColumn.Annotations.GetValue(MetadataUtils.Kinds.SlotNames, ref slotNames);
...

            {
                ...
                treeLeafIdsColumn.Annotations.GetValue(MetadataUtils.Kinds.IsNormalized, ref leafIdsNormalizedFlag);
                ...
                treeLeafIdsColumn.Annotations.GetValue(MetadataUtils.Kinds.SlotNames, ref leafIdsSlotNames);
...

            {
                ...
                treePathIdsColumn.Annotations.GetValue(MetadataUtils.Kinds.IsNormalized, ref pathIdsNormalizedFlag);
                Assert.True(pathIdsNormalizedFlag);
                // Check metadata field SlotNames's content.
                VBuffer<ReadOnlyMemory<char>> pathIdsSlotNames = default;
                treePathIdsColumn.Annotations.GetValue(MetadataUtils.Kinds.SlotNames, ref pathIdsSlotNames);
