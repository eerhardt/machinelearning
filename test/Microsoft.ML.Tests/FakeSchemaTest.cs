...
namespace Microsoft.ML.Tests
{
    public class FakeSchemaTest : BaseTestClass
    {
        ...
        void SimpleTest()
        {
            ...
            metadataBuilder.Add("M", NumberDataViewType.R4, (ref float v) => v = 484f);
            var schemaBuilder = new SchemaBuilder();
            schemaBuilder.AddColumn("A", new VectorType(NumberDataViewType.R4, 94));
            schemaBuilder.AddColumn("B", new KeyType(typeof(uint), 17));
            schemaBuilder.AddColumn("C", NumberDataViewType.I4, metadataBuilder.GetMetadata());
            ...
            Assert.Equal(NumberDataViewType.R4, columnA.Type.GetItemType());
            ...
            Assert.Equal(NumberDataViewType.I4, columnC.Type);
