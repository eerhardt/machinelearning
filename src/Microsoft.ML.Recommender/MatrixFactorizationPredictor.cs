...
namespace Microsoft.ML.Trainers.Recommender
{
    ...
    public sealed class MatrixFactorizationPredictor : IPredictor, ICanSaveModel, ICanSaveInTextFormat, ISchemaBindableMapper
    {
        ...
        public DataViewType OutputType { get { return NumberDataViewType.Float; } }

        public DataViewType MatrixColumnIndexType { get; }
        public DataViewType MatrixRowIndexType { get; }
        ...
        private sealed class RowMapper : ISchemaBoundRowMapper
        {
            ...
            public RowMapper(IHostEnvironment env, MatrixFactorizationPredictor parent, RoleMappedSchema schema, DataViewSchema outputSchema)
            {
    ...
    public sealed class MatrixFactorizationPredictionTransformer : PredictionTransformerBase<MatrixFactorizationPredictor, GenericScorer>, ICanSaveModel
    {
        ...
        public DataViewType MatrixColumnIndexColumnType { get; }
        public DataViewType MatrixRowIndexColumnType { get; }
        ...
        public MatrixFactorizationPredictionTransformer(IHostEnvironment env, MatrixFactorizationPredictor model, DataViewSchema trainSchema,
