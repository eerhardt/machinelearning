...
namespace Microsoft.ML.Trainers
{
        ...
        IEstimator<MatrixFactorizationPredictionTransformer>
    {
        ...
        private MatrixFactorizationPredictor TrainCore(IChannel ch, RoleMappedData data, RoleMappedData validData = null)
        {
            ...
            if (labelCol.Type != NumberDataViewType.R4 && labelCol.Type != NumberDataViewType.R8)
            ...
            if (validData != null)
            {
                ...
                if (validLabelCol.Type != NumberDataViewType.R4 && validLabelCol.Type != NumberDataViewType.R8)
            ...
            using (var cursor = data.Data.GetRowCursor(matrixColumnIndexColInfo, matrixRowIndexColInfo, data.Schema.Label.Value))
            {
                ...
                var labGetter = RowCursorUtils.GetGetterAs<float>(NumberDataViewType.R4, cursor, data.Schema.Label.Value.Index);
                var matrixColumnIndexGetter = RowCursorUtils.GetGetterAs<uint>(NumberDataViewType.U4, cursor, matrixColumnIndexColInfo.Index);
                var matrixRowIndexGetter = RowCursorUtils.GetGetterAs<uint>(NumberDataViewType.U4, cursor, matrixRowIndexColInfo.Index);
                ...
                else
                {
                    ...
                    {
                        ValueGetter<float> validLabelGetter = RowCursorUtils.GetGetterAs<float>(NumberDataViewType.R4, validCursor, validData.Schema.Label.Value.Index);
                        var validMatrixColumnIndexGetter = RowCursorUtils.GetGetterAs<uint>(NumberDataViewType.U4, validCursor, validMatrixColumnIndexColInfo.Index);
                        var validMatrixRowIndexGetter = RowCursorUtils.GetGetterAs<uint>(NumberDataViewType.U4, validCursor, validMatrixRowIndexColInfo.Index);
        ...
        public SchemaShape GetOutputSchema(SchemaShape inputSchema)
        {
            ...
            var labelColumn = new SchemaShape.Column(LabelName, SchemaShape.Column.VectorKind.Scalar, NumberDataViewType.R4, false);
            ...
            var matrixColumnIndexColumn = new SchemaShape.Column(MatrixColumnIndexName, SchemaShape.Column.VectorKind.Scalar, NumberDataViewType.U4, true);
            var matrixRowIndexColumn = new SchemaShape.Column(MatrixRowIndexName, SchemaShape.Column.VectorKind.Scalar, NumberDataViewType.U4, true);
