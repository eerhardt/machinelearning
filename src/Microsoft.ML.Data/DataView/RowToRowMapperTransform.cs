...
namespace Microsoft.ML.Data
{
    ...
    public delegate void SignatureLoadRowMapper(ModelLoadContext ctx, DataViewSchema schema);
        ...
        ITransformCanSaveOnnx, ITransformCanSavePfa, ITransformTemplate
    {
        ...
        [BestFriend]
        internal RowToRowMapperTransform(IHostEnvironment env, IDataView input, IRowMapper mapper, Func<DataViewSchema, IRowMapper> mapperFactory)
        ...
        [BestFriend]
        internal static DataViewSchema GetOutputSchema(DataViewSchema inputSchema, IRowMapper mapper)
        {
